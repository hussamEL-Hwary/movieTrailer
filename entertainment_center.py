...
lion = Movie(
    "lion",
    "Five year old Saroo gets lost on a train which "
    "takes him thousands of miles across India",
...
the_light_between_oceans = Movie(
    "The Light Between Oceans",
    "Tom is a World War I veteran "
    "who maintains a lighthouse off "
    "the shore of Australia with his wife Isabel,",
    "https://upload.wikimedia.org/wikipedia/en/9/91/The_Light_Between_Oceans_poster.jpg",  # NOQA
    "https://www.youtube.com/watch?v=lk7yw00a4fs"
    )

# create fourth movie object
me_before_you = Movie(
    "Me Before You",
    "A girl in a small town forms an unlikely "
    "bond with a recently-paralyzed man "
